    ...
    <div className="min-h-screen bg-white text-[#1f2329] font-sans selection:bg-[#1f2329] selection:text-white pb-0">
      ...
      <nav className="absolute top-0 w-full z-50">
        <div className="max-w-[1400px] mx-auto px-8 py-6 flex justify-between items-center text-white">
          ...
          <div className="flex space-x-10 text-sm font-bold drop-shadow-md items-center">
      ...
      {/* 3D Model Viewer Section (Image 2 Ref) */}
      <section id="planner" className="max-w-[1200px] mx-auto px-8 py-32 text-center">
        <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-4">Real Equipment Library</p>
        <h2 className="text-5xl font-black text-[#1f2329] mb-6 tracking-tight">Real gear, modeled in 3D.</h2>
        ...
        {/* 3D Viewer Container */}
        <div className="bg-[#f8f9fa] rounded-2xl border border-gray-200 h-[600px] relative overflow-hidden shadow-inner flex flex-col items-center">
          {/* Top Left Text Layer */}
      ...
      {/* Wide Image Section with Hover Cards (Image 4 Ref) */}
      <section className="relative bg-[#111] pt-32 pb-24 border-y border-zinc-900">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
            {/* Hover Card 1 */}
            <div className="bg-white rounded-2xl overflow-hidden shadow-2xl transition-transform duration-500 hover:-translate-y-4">
              ...
              <div className="p-8 pb-10 bg-white">
                <h3 className="text-xl font-bold text-[#1f2329] mb-2">Cardio & Warmup</h3>
                <p className="text-gray-500 text-sm mb-4">By The W Gym</p>
                <div className="flex gap-2">
                  <span className="px-3 py-1 bg-gray-100 text-gray-500 rounded text-xs font-bold">TREADMILLS</span>
                  <span className="px-3 py-1 bg-gray-100 text-gray-500 rounded text-xs font-bold">CYCLES</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-2xl transition-transform duration-500 hover:-translate-y-4">
              ...
              <div className="p-8 pb-10 bg-white">
                <h3 className="text-xl font-bold text-[#1f2329] mb-2">Free Weights Area</h3>
                <p className="text-gray-500 text-sm mb-4">By The W Gym</p>
                <div className="flex gap-2">
                  <span className="px-3 py-1 bg-gray-100 text-gray-500 rounded text-xs font-bold">DUMBBELLS</span>
                  <span className="px-3 py-1 bg-gray-100 text-gray-500 rounded text-xs font-bold">BENCHES</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-2xl transition-transform duration-500 hover:-translate-y-4">
              ...
              <div className="p-8 pb-10 bg-white">
                <h3 className="text-xl font-bold text-[#1f2329] mb-2">Strength Machines</h3>
                <p className="text-gray-500 text-sm mb-4">By The W Gym</p>
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-gray-100 text-gray-500 rounded text-xs font-bold">CABLES</span>
                  <span className="px-3 py-1 bg-gray-100 text-gray-500 rounded text-xs font-bold">LEG PRESS</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Features & Steps Section (Image 5 Ref) */}
      <section className="bg-white py-32 border-b border-gray-200">
        <div className="max-w-[1200px] mx-auto px-8">
          
          {/* Top Half: Left Title, Right List */}
          <div className="flex flex-col md:flex-row gap-16 mb-40">
            <div className="flex-1">
              ...
              <h2 className="text-5xl font-black text-[#1f2329] leading-tight max-w-md">
            ...
            <div className="flex-1 flex flex-col gap-10 mt-12 md:mt-0">
              <div className="flex gap-6">
                <span className="text-gray-300 font-bold text-sm mt-1">01</span>
                <div>
                  <h4 className="text-lg font-bold text-[#1f2329] mb-2">Prime Location & Parking</h4>
                  <p className="text-gray-500 leading-relaxed">Located at Infinity Tower on GMS Rd with dedicated basement parking for hassle-free access.</p>
                </div>
              </div>
              <div className="flex gap-6 border-t border-gray-100 pt-10">
                <span className="text-gray-300 font-bold text-sm mt-1">02</span>
                <div>
                  <h4 className="text-lg font-bold text-[#1f2329] mb-2">Genuine Professional Trainers</h4>
                  <p className="text-gray-500 leading-relaxed">Our trainers are experienced, polite, and dedicated to maintaining a healthy environment.</p>
                </div>
              </div>
              <div className="flex gap-6 border-t border-gray-100 pt-10">
                <span className="text-gray-300 font-bold text-sm mt-1">03</span>
                <div>
                  <h4 className="text-lg font-bold text-[#1f2329] mb-2">Immaculate Cleanliness</h4>
                  <p className="text-gray-500 leading-relaxed">Enjoy a neat, clean facility complete with a cafeteria to fuel up post-workout.</p>
                </div>
              </div>
            </div>
          </div>

          {/* Bottom Half: Three Steps */}
          <div className="text-center mb-16">
            <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-4">How it works</p>
            <h2 className="text-4xl font-black text-[#1f2329]">Three steps to get started.</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="border border-gray-200 rounded-2xl p-8 hover:border-gray-300 transition-colors">
              <div className="w-8 h-8 bg-[#1f2329] text-white rounded flex items-center justify-center font-bold mb-6">1</div>
              <h4 className="text-xl font-bold text-[#1f2329] mb-3">Visit the Gym</h4>
              <p className="text-gray-500 text-sm leading-relaxed">Drop by Infinity Tower. Check out our spacious floors, top-tier equipment, and meet the trainers.</p>
            </div>
            
            <div className="border border-gray-200 rounded-2xl p-8 hover:border-gray-300 transition-colors">
              <div className="w-8 h-8 bg-[#1f2329] text-white rounded flex items-center justify-center font-bold mb-6">2</div>
              <h4 className="text-xl font-bold text-[#1f2329] mb-3">Choose your plan</h4>
              <p className="text-gray-500 text-sm leading-relaxed">Simple transparent pricing at ₹2k/month. No hidden fees, just full access to everything.</p>
            </div>
            
            <div className="border border-gray-200 rounded-2xl p-8 hover:border-gray-300 transition-colors">
              <div className="w-8 h-8 bg-[#1f2329] text-white rounded flex items-center justify-center font-bold mb-6">3</div>
              <h4 className="text-xl font-bold text-[#1f2329] mb-3">Start Training</h4>
              <p className="text-gray-500 text-sm leading-relaxed">Jump right in. Join our community and elevate your fitness journey from day one.</p>
            </div>
          </div>
      ...
      {/* Footer */}
      <footer id="contact" className="bg-[#1f2329] text-white pt-24 pb-12">
